...
export const Header = () => {
  ...
  return (
    <header>
      <nav className="fixed left-[50%] h-14 w-[40rem] -translate-x-1/2 gap-2 whitespace-nowrap border border-t-0 text-sm backdrop-blur">
        <div className="absolute right-[100%] space-y-2 pr-8 pt-4">
          <h1 className="font-geistsans text-2xl font-bold leading-6">jje</h1>
          ...
          {!inSignInPage && (
            <Link
              className={`${buttonVariants({ variant: "default" })} w-22 font-geistsans`}
